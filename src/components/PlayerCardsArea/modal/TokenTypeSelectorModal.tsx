    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          ...
          >
            <div className="w-10 h-10 rounded-full bg-white border-2 border-gray-700 flex items-center justify-center mb-2 font-bold">
              I
            </div>
          ...
          >
            <div className="w-10 h-10 rounded-full bg-red-500 border-2 border-gray-700 flex items-center justify-center mb-2 font-bold text-white">
              P
            </div>
